                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between mt-200">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <svg  stroke="currentColor" class="-mt-px w-5 h-5 text-gray-400" viewBox="0 0 512 512">
                    ...
                    Funa Akatale v{{ Illuminate\Foundation\Application::VERSION }} 
